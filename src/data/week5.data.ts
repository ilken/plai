	...
	"predictions": [
		{
			...
			"result": {
				...
				"probability": 50,
				"analysis": "Chelsea have a slightly better record this season, but Brighton are unpredictable at home. It could go either way, but Chelsea's slight edge in quality might be the decider."
			},
			"overUnder": {
		...
		},
		{
			...
			"result": {
				...
				"probability": 70,
				"analysis": "Arsenal are strong favourites against a struggling Leicester City. Arsenal's attack should be too much for Leicester."
			},
			"overUnder": {
		...
		},
		{
			...
			"result": {
				...
				"probability": 65,
				"analysis": "Aston Villa are the stronger side and should be able to win at home against Ipswich Town."
			},
			"overUnder": {
				"prediction": "Under 2.5 Goals",
				"probability": 60,
		...
		},
		{
			...
			"result": {
				"prediction": "Draw",
				"probability": 45,
				"analysis": "Both teams are evenly matched, and it could be a close contest. A draw is a likely outcome."
			},
			"overUnder": {
				"prediction": "Under 2.5 Goals",
				"probability": 65,
		...
		},
		{
			...
			"result": {
				...
				"probability": 75,
				"analysis": "Manchester City are the stronger team and are likely to win at home. Newcastle can be dangerous on the counter, but City's attack is formidable."
			},
			"overUnder": {
				"prediction": "Over 2.5 Goals",
				"probability": 70,
				"analysis": "City's games are usually high scoring, and Newcastle can contribute to the goal count."
			},
			"bothTeamsToScore": {
				"prediction": "Yes",
				"probability": 65,
		...
		},
		{
			...
			"result": {
				...
				"probability": 55,
				"analysis": "Bournemouth have been the slightly better side this season and might edge this encounter."
			},
			"overUnder": {
				"prediction": "Over 2.5 Goals",
				"probability": 55,
		...
		},
		{
			...
			"result": {
				...
				"probability": 50,
				"analysis": "West Ham at home can be a tough opponent, and they might have a slight advantage over Brentford."
			},
			"overUnder": {
				"prediction": "Over 2.5 Goals",
				"probability": 50,
		...
		},
		{
			...
			"result": {
				...
				"probability": 55,
				"analysis": "Crystal Palace at home are a tough team to beat, and Everton have been inconsistent."
			},
			"overUnder": {
				"prediction": "Under 2.5 Goals",
				"probability": 60,
			...
			"bothTeamsToScore": {
				"prediction": "No",
				"probability": 65,
				"analysis": "Palace's defense can be difficult to break down, and Everton might struggle to score."
			}
		},
		{
		...
		},
		{
			...
			"result": {
				"prediction": "Draw",
				"probability": 40,
				"analysis": "This is a tough game to call. Both teams have attacking talent, but also defensive vulnerabilities. A draw is a plausible outcome."
			},
			"overUnder": {
				"prediction": "Over 2.5 Goals",
				"probability": 60,
