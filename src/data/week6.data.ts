  ...
  "predictions": [
    {
      ...
      bothTeamsToScore: {
        ...
        probability: 60,
        analysis:
          "Both teams have decent attacks, and it's likely both will find the net.",
      },
    },
    {
      ...
      "result": {
        ...
        "probability": 55,
        "analysis": "Leicester are struggling, and Brentford have been more consistent. Brentford's attack could exploit Leicester's weaknesses."
      },
      "overUnder": {
        "prediction": "Over 2.5 Goals",
        "probability": 55,
        "analysis": "Leicester's games have seen goals, and Brentford can contribute to the scoreline."
      },
      "bothTeamsToScore": {
        "prediction": "Yes",
        "probability": 60,
    ...
    },
    {
      ...
      "result": {
        "prediction": "Draw",
        "probability": 45,
        "analysis": "A close match between two sides with similar form. A draw seems the most likely outcome."
      },
      "overUnder": {
    ...
    },
    {
      ...
      "result": {
        ...
        "probability": 55,
        "analysis": "Bournemouth have been slightly better this season and have the home advantage. Wolves' struggles might continue."
      },
      "overUnder": {
        "prediction": "Over 2.5 Goals",
        "probability": 50,
        "analysis": "Both teams have shown attacking and defensive vulnerabilities, so there could be goals."
      },
      "bothTeamsToScore": {
        "prediction": "Yes",
        "probability": 55,
    ...
    },
    {
      ...
      "result": {
        ...
        "probability": 65,
        "analysis": "Arsenal are strong favorites at home. West Ham can be inconsistent, and Arsenal's quality should prevail."
      },
      "overUnder": {
        "prediction": "Under 2.5 Goals",
        "probability": 50,
    ...
    },
    {
      ...
      "result": {
        ...
        "probability": 65,
        "analysis": "Spurs are the stronger side and should be able to overcome Ipswich, who are struggling near the bottom of the table."
      },
      "overUnder": {
        "prediction": "Over 2.5 Goals",
        "probability": 60,
    ...
    },
    {
      ...
      "result": {
        ...
        "probability": 60,
        "analysis": "Brighton are the better team and should be able to win against a struggling Southampton side."
      },
      "overUnder": {
        "prediction": "Under 2.5 Goals",
        "probability": 55,
        "analysis": "Southampton have struggled to score, and Brighton might not need many goals to win."
      },
      "bothTeamsToScore": {
        "prediction": "No",
        "probability": 60,
    ...
    },
    {
      ...
      "result": {
        ...
        "probability": 55,
        "analysis": "Chelsea are slightly stronger and should edge this encounter. Villa can be tough at home, but Chelsea's quality might make the difference."
      },
      "overUnder": {
        "prediction": "Over 2.5 Goals",
        "probability": 55,
    ...
    },
    {
      ...
      "result": {
        ...
        "probability": 60,
        "analysis": "Newcastle are the stronger team and are likely to win at home. Forest can be dangerous, but Newcastle's home form gives them the edge."
      },
      "overUnder": {
        "prediction": "Over 2.5 Goals",
        "probability": 55,
    ...
    },
    {
      ...
      "result": {
        "prediction": "Draw",
        "probability": 40,
        "analysis": "This is the biggest game of the week, and it's a tough one to call. Both teams are strong, but City's home advantage might be slightly neutralized by Liverpool's attacking threat. A draw is a real possibility."
      },
      "overUnder": {
        "prediction": "Over 2.5 Goals",
        "probability": 65,
