  ...
  predictions: [
    ...
    },
    {
      ...
      overUnder: {
        ...
        probability: 55,
        analysis:
          'Neither team is particularly free-scoring, suggesting a low-scoring game.',
      },
      bothTeamsToScore: {
        prediction: 'Yes',
        probability: 50,
    ...
    },
    {
      ...
      overUnder: {
        ...
        probability: 50,
        analysis:
          "Arsenal's defense has been solid, and West Ham might struggle to score.",
      },
      bothTeamsToScore: {
        prediction: 'No',
        probability: 55,
    ...
    },
    {
      ...
      result: {
        ...
        probability: 45,
        analysis:
          'A close match between two mid-table sides. A draw seems a likely outcome.',
      },
      overUnder: {
        prediction: 'Under 2.5 Goals',
        probability: 55,
        analysis:
          'Neither team is known for high-scoring games, suggesting a tight affair.',
      },
      bothTeamsToScore: {
        prediction: 'Yes',
        probability: 50,
        analysis:
          "Both teams have the potential to score, but it's not a certainty.",
      },
    },
    {
      ...
      overUnder: {
        ...
        probability: 60,
        analysis:
          "Spurs' attack should be too strong for Ipswich, and there could be goals.",
      },
      bothTeamsToScore: {
        prediction: 'Yes',
        probability: 55,
        analysis:
          'Ipswich might get a goal, but Spurs are likely to score more.',
      },
    },
    {
    ...
    },
    {
      ...
      overUnder: {
        ...
        probability: 55,
        analysis:
          'Both teams have shown they can score, and it could be an open game.',
      },
      bothTeamsToScore: {
        prediction: 'Yes',
        probability: 60,
    ...
    },
    {
      ...
      overUnder: {
        ...
        probability: 55,
        analysis:
          "Newcastle's games can be open, and Forest can contribute to the goals.",
      },
      bothTeamsToScore: {
        prediction: 'Yes',
        probability: 55,
        analysis:
          "Forest have a decent attack and might get a goal, even at St. James' Park.",
      },
    },
    {
      ...
      overUnder: {
        ...
        probability: 65,
        analysis:
          'Both teams have potent attacks, and a high-scoring game is expected.',
      },
      bothTeamsToScore: {
        prediction: 'Yes',
        probability: 70,
        analysis:
          'Both teams are almost certain to score in this clash of the titans.',
      },
    },
  ],
};
